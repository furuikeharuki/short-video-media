...
- **広告**: `/feed` 上部に ExoClick バナー (`components/ads/ExoClickBanner.tsx`)。`NEXT_PUBLIC_ADS_ENABLED=true` の時のみ表示。zone id は `NEXT_PUBLIC_EXOCLICK_BANNER_ZONE_ID` で上書き可 (デフォルト `5929876`)
