...
const scrollStyle: CSSProperties = { flex: 1, overflowY: "auto" };
const heroWrapStyle: CSSProperties = {
  position: "relative", width: "100%", height: "55svh",
  overflow: "hidden", background: "#111",
  display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0,
};
const heroBgSkeletonStyle: CSSProperties = { position: "absolute", inset: 0, background: "#1c1c1c" };
const heroImgSkeletonStyle: CSSProperties = {
  position: "relative", zIndex: 1, width: "auto", height: "85%",
  maxWidth: "calc(100% - 60px)", aspectRatio: "9/16",
...
const contentStyle: CSSProperties = {
  padding: "20px 16px 48px", width: "100%", boxSizing: "border-box",
};
...
const badgeSkelStyle: CSSProperties = {
  ...
  background: "#2a2a2a", animation: "shimmer 1.4s ease-in-out infinite",
};
const metaBlockStyle: CSSProperties = {
  borderTop: "1px solid rgba(255,255,255,0.08)", marginBottom: 24,
};
